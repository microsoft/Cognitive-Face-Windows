# Microsoft Face API: Windows Client Library 
This repo contains the Windows client library & sample for the Microsoft Face API, part of [Cognitive Services](https://www.microsoft.com/cognitive-services).
